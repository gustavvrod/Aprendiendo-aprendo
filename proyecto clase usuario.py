...
class RegistraUsuario():
    def __init__(self,window):
        self.window=window        
        self.greeting = tk.Label(text="Administrador de empleado",fg="white",bg="black",height=10)
        self.greeting.pack()
        self.label_nombre = tk.Label(text="ingrese usuario a crear: ",fg="red",bg="white")
        self.label_nombre.pack()
        self.entry_nombre = tk.Entry(self.window)
        self.entry_nombre.pack()
        self.label_contrasena = tk.Label(text="ingrese contraseña a crear: ",fg="red",bg="white")
        self.label_contrasena.pack()
        self.entry_contrasena = tk.Entry(self.window)
        self.entry_contrasena.pack()
        self.label_correo = tk.Label(text="ingrese correo: ",fg="red",bg="white")
        self.label_correo.pack()
        self.entry_correo = tk.Entry(self.window)
        self.entry_correo.pack()
        self.button=tk.Button(text="CREAR",command=self.crear_usuario)
        self.button.pack()
